...
class Viewer(object):
    def __init__(self, gt_trajectory=None):
        ...
        # Ground-truth trajectory (N, 3) expressed in the filter frame.
        # Rendered statically in red alongside the live (black) estimate.
        self.gt_trajectory = (
    ...
    def view(self):
        ...
        while not pangolin.ShouldQuit():
            ...
            # ground-truth trajectory (red/pink)
            if self.gt_trajectory is not None and len(self.gt_trajectory) > 0:
                gl.glLineWidth(2)
                gl.glColor3f(1.0, 0.3, 0.5)
                pangolin.DrawLine(self.gt_trajectory)
